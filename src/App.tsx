...
const BADGE = "inline-block text-[0.7rem] px-2.5 py-0.5 rounded-[5px] tracking-[0.02em] normal-case border";
      ...
      <div className="min-h-screen bg-[var(--bg2)] text-[var(--c-text)] font-sans relative">
        ...
        <header className="text-center pt-12 px-6 pb-3">
          ...
          <p className="text-sm opacity-60 mb-3">
            ...
            <a href="https://kube.io/blog/liquid-glass-css-svg" target="_blank" rel="noreferrer" className={LINK}>
              kube.io
            </a>.
          </p>
        </header>
        <main className="grid grid-cols-2 gap-x-8 gap-y-4 max-w-[1400px] mx-auto px-6 pb-16 relative before:content-[''] before:absolute before:top-0 before:bottom-0 before:left-1/2 before:w-px before:bg-[var(--ui-border)]">
          <div className="mb-6">
            <div className="text-[0.8rem] font-semibold uppercase tracking-[0.08em] opacity-50">
              WebGL + GLSL · via{" "}
              <a href="https://github.com/WICG/html-in-canvas" target="_blank" rel="noreferrer" className={LINK}>
                HTML-in-Canvas
              </a>{" "}
              <span className={`${BADGE} bg-emerald-500/15 border-emerald-500/30 text-emerald-600 dark:text-emerald-400`}>
                Cross-browser
              </span>
            </div>
          ...
          <div className="mb-6">
            <div className="text-[0.8rem] font-semibold uppercase tracking-[0.08em] opacity-50">
              Using{" "}
              <a href="https://github.com/hashintel/hash/tree/main/libs/%40hashintel/refractive" target="_blank" rel="noreferrer" className="text-inherit underline">
                @hashintel/refractive
              </a>{" "}
              <span className={`${BADGE} bg-yellow-500/15 border-yellow-500/30 text-yellow-600 dark:text-amber-400`}>
                Chrome only
              </span>
            </div>
            <p className="text-[0.82rem] opacity-55 mt-2 leading-relaxed">
              ...
              capture, no shader. Only works in Chromium-based browsers right now.
            </p>
          </div>
